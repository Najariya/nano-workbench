...
3. Trigger Export conversation and confirm it does not require a pointer-only action.
4. Trigger New thread and confirm the current conversation resets cleanly.
