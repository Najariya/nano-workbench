...
| IMP-028 | In progress | P2 | Meetings | Improve meeting notes capture. | Build `6.8.17` includes meeting-note start/stop, first-use speech disclosure, local transcript capture, AI notes with action items, Memos saving, transcript copy, Markdown export, helper/UI wiring regression coverage, Doctor voice-readiness checks, and safe Doctor workflow evidence; manual Chrome mic QA remains. |
