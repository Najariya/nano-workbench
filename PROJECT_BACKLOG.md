...
| IMP-028 | In progress | P2 | Meetings | Improve meeting notes capture. | Build `6.8.15` adds meeting-note start/stop, first-use speech disclosure, local transcript capture, AI notes with action items, Memos saving, transcript copy, Markdown export, helper regression coverage, and Doctor voice-readiness checks; manual Chrome mic QA remains. |
...
| IMP-031 | In progress | P1 | Voice | Add Momo-style voice capture refinements. | Build `6.8.15` adds quick voice memos with cleanup/action items, saved local transcripts, copy/export actions, speech-recognition disclosure, helper regression coverage, and Doctor/health voice-readiness checks; manual mic QA remains. |
...
| IMP-028 | In progress | Improve meeting notes capture. | Meeting notes are a high-value local AI workflow when capture, cleanup, and summarization are frictionless. | Meeting notes can start from More/slash command, transcribe the mic, summarize into sections/action items, save to Memos, copy transcript, export Markdown, disclose Chrome speech behavior, and report speech/mic readiness in Doctor; manual mic QA remains. |
