...
- `screenshots/02-image-ocr-right-click.png` - 1280 x 800 real-screenshot composite highlighting the right-click image OCR onboarding step.
- `screenshots/03-model-setup.png` - 1280 x 800 real-screenshot composite showing Gemini Nano download and ready states.
...
- `promo/gemini-nano-workbench-promo.mp4` - optional local promo video. Chrome Web Store expects a YouTube URL, so upload this video to YouTube and paste the video link if you want to use the video field.
